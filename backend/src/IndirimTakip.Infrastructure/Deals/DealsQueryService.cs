    ...
    ProductImageOptions gorselAyarlari)
{
    ...
    internal static readonly TimeSpan StaleThreshold = TimeSpan.FromHours(48);
    ...
    //
    // Buradaki şart CatalogStatsQueryService.GetBrandStatsAsync ile BİREBİR AYNI (aktif marka + bayat
